...
class Gate:
    ...
    def __init__(self, policies: list[Policy], audit_path: str | None = None):
        self.policies = policies
        self.state = StateStore()
        self.audit = AuditLog(audit_path) if audit_path else None

    @classmethod
    def from_yaml(cls, path: str, audit_path: str | None = None) -> Gate:
    ...
    @classmethod
    def from_dict(cls, config: dict[str, Any], audit_path: str | None = None) -> Gate:
    ...
    def evaluate(self, tool_call: dict[str, Any] | ToolCall) -> Verdict:
        ...
        verdict = Verdict(decision=decision, violations=violations, receipt=receipt,
                          latency_ms=latency, tool_call=tc)
