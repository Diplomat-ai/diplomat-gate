...
class ToolCall:
    ...
    def from_dict(cls, d: dict[str, Any]) -> ToolCall:
        ...
        return cls(action=action, params=d, agent_id=str(agent_id), context=context if isinstance(context, dict) else {})
...
def _make_receipt(
    ...
    return Receipt(
        ...
        violations=[
            {"policy_id": v.policy_id, "severity": v.severity, "message": v.message}
            for v in violations
        ],
    )
